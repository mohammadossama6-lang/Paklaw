        ...
        {NATIONALITY_OPTIONS.map((opt) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[13px] font-medium leading-tight text-ink sm:text-sm">{opt.label}</span>
            </label>
          );
        })}
      </div>
